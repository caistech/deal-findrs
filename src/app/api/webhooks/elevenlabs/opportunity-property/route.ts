// POST /api/webhooks/elevenlabs/opportunity-property
//
// Post-call webhook for the property-details voice agent.
// Transcript-log only — form fields are written by client tools (set_property_fields).
//
...
export async function POST(request: NextRequest) {
  ...
  if (!verified.ok) {
    console.error('[webhook/opportunity-property] HMAC verification failed:', verified.error)
  ...
  console.log('[webhook/opportunity-property] conversation_id:', conversationId)
  ...
  if (error) {
    console.error('[webhook/opportunity-property] voice_transcripts insert failed:', error.message)
  }
