// POST /api/webhooks/elevenlabs/opportunity-financial
//
// Post-call webhook for the financial-details voice agent.
// Transcript-log only — form fields are written by client tools (set_financial_fields).
//
...
export async function POST(request: NextRequest) {
  ...
  if (!verified.ok) {
    console.error('[webhook/opportunity-financial] HMAC verification failed:', verified.error)
  ...
  console.log('[webhook/opportunity-financial] conversation_id:', conversationId)
  ...
  if (error) {
    console.error('[webhook/opportunity-financial] voice_transcripts insert failed:', error.message)
  }
