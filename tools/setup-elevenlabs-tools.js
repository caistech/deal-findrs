  ...
  property: [{
    ...
    parameters: {
      ...
      properties: {
        ...
        propertySizeUnit:    { type: 'string', description: 'Unit for land size: sqm, hectares, or acres', enum: ['sqm', 'hectares', 'acres'] },
        landStage:           { type: 'string', description: 'Current planning stage of the land', enum: ['da_approved', 'da_lodged', 'needs_rezoning', 'raw_land', 'construction_ready'] },
        ...
        deriskDaApproved:               { type: 'boolean', description: 'True if the development application is already approved' },
        deriskVendorFinance:            { type: 'boolean', description: 'True if the vendor will finance some or all of the land purchase' },
        deriskFixedPriceConstruction:   { type: 'boolean', description: 'True if a fixed-price construction contract is in place' },
        deriskConstructionPartner:      { type: 'string', description: 'Builder name, e.g. "Factory2Key"' },
        deriskExperiencedPm:            { type: 'boolean', description: 'True if an experienced project manager is engaged' },
        deriskPmName:                   { type: 'string', description: 'Name of the project manager' },
        deriskClearTitle:               { type: 'boolean', description: 'True if the title is clear of encumbrances' },
        deriskGrowthCorridor:           { type: 'boolean', description: 'True if the property is in a designated growth corridor' },
        riskPreviousDisputes:    { type: 'boolean', description: 'True if there are previous legal disputes on the property' },
        riskDisputeDetails:      { type: 'string', description: 'Details of any previous legal disputes' },
        riskEnvironmentalIssues: { type: 'boolean', description: 'True if there are known environmental concerns (contamination, flooding, etc.)' },
        riskEnvironmentalDetails:{ type: 'string', description: 'Details of any environmental concerns' },
        riskHeritageOverlay:     { type: 'boolean', description: 'True if a heritage overlay applies to the property' },
        riskHeritageDetails:     { type: 'string', description: 'Details of any heritage overlay' },
      },
    },
  }],
  ...
  derisk: [{
    ...
    parameters: {
      ...
      properties: {
        deriskDaApproved:               { type: 'boolean', description: 'True if the development application is already approved' },
        deriskVendorFinance:            { type: 'boolean', description: 'True if the vendor will finance some or all of the land purchase' },
        deriskVendorFinanceTerms:       { type: 'string', description: 'Vendor finance terms (rate, term, deposit), e.g. "30% deposit, 6% over 24 months"' },
        deriskFixedPriceConstruction:   { type: 'boolean', description: 'True if a fixed-price construction contract is in place' },
        deriskConstructionPartner:      { type: 'string', description: 'Builder name, e.g. "Factory2Key"' },
        deriskExperiencedPm:            { type: 'boolean', description: 'True if an experienced project manager is engaged' },
        deriskPmName:                   { type: 'string', description: 'Name of the project manager' },
